  ...
  [37],
  {
    ...
    85127: (e, t, a) => {
          ...
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)("p", {
                  ...
                  children: "\xa9 OptimAI Network 2024",
                }),
                (0, i.jsx)("div", {
                  className:
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsxs)("a", {
                  className:
                    "block text-12 font-semibold text-white lg:text-16",
                  href: "mailto:contact@optimai.network",
                  children: [
                    "Email: ",
                    (0, i.jsx)("span", {
                      className: "hover:text-[#71717A]",
                      children: "contact@optimai.network",
                    }),
                  ],
                }),
                (0, i.jsxs)("div", {
                  ...
                  children: [
                    (0, i.jsx)("a", {
                      className:
                        "block text-12 font-semibold text-white opacity-50 transition-colors hover:text-[#71717A] lg:text-16",
                      href: "#",
                      children: "Privacy",
                    }),
                    (0, i.jsx)("span", {
                      className:
                        "block text-12 font-semibold text-white opacity-50 lg:text-16",
                      children: "|",
                    }),
                    (0, i.jsx)("a", {
                      className:
      ...
      let p = () =>
        (0, i.jsx)("div", {
          className:
            "relative grid w-full grid-cols-1 border-b border-white/8 md:grid-cols-2 xl:grid-cols-1 xl:border-b-0 xl:border-r xl:pt-5",
          children: [
            {
              title: "Our Solutions",
              items: [
                { title: "L2 Depin Blockchain", href: "#" },
                { title: "Reinforement Data layer", href: "#" },
                { title: "Optimai Nodes", href: "#" },
                { title: "GenAI Agents", href: "#" },
              ],
            },
            {
              title: "Resources",
              items: [
                ...
                { title: "Download Node", href: "/#nodes" },
              ],
            },
          ].map((e) =>
            (0, i.jsxs)(
              ...
              {
                className:
                  "flex size-full flex-col items-start border-white/8 px-4 py-7 first:border-b md:px-8 md:first:border-transparent xl:px-10 xl:pt-12 xl:first:border-white/8",
                children: [
                  (0, i.jsx)("p", {
                    className:
                      "w-full whitespace-nowrap text-start text-18 font-bold xl:text-24",
                    children: e.title,
                  }),
                  (0, i.jsx)("ul", {
                    className:
                      "mt-4 grid w-full grid-cols-2 gap-3 md:grid-cols-1 xl:grid-cols-2",
                    children: e.items.map((e) =>
                      (0, i.jsx)(
                        "li",
                        {
                          className:
                            "group whitespace-nowrap text-12 font-medium leading-normal text-white/80 xl:text-16",
                          children: (0, i.jsxs)(m(), {
                            href: e.href,
                            className:
                              "flex items-center gap-2 transition-transform group-hover:translate-x-3",
                            children: [
                              (0, i.jsx)("span", {
      ...
      let k = () => {
          let e = [
            ...
            {
              title: "Youtube",
              href: "https://www.youtube.com/@optimainetwork",
              icon: u.A.Youtube,
            },
          ];
          return (0, i.jsx)("div", {
