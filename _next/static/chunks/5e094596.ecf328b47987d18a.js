  ...
  [804],
  {
    44003: (e, t, a) => {
      ...
      function R(e, t) {
        ...
        for (var a = 0, l = Array(t); a < t; a++) l[a] = e[a];
        return l;
      }
      function L(e, t, a) {
      ...
      function P(e, t, a) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            W()
              ? Reflect.construct(t, a || [], F(e).constructor)
              : t.apply(e, a)
          )
        );
      }
      ...
      function U(e, t, a) {
        ...
        var l = [null];
        return l.push.apply(l, t), new (e.bind.apply(e, l))();
      }
      function H(e, t, a) {
        return (
          t &&
            (function (e, t) {
              for (var a = 0; a < t.length; a++) {
                ...
                (l.enumerable = l.enumerable || !1),
                  ...
                  Object.defineProperty(e, Z(l.key), l);
              }
            })(e.prototype, t),
          ...
          "undefined" != typeof Reflect && Reflect.get
            ...
            : function (e, t, a) {
                ...
                if (l) {
                  ...
                  return n.get
                    ? n.get.call(arguments.length < 3 ? e : a)
                    : n.value;
                }
      ...
      var et = function (e) {
        ...
        ea = function (e) {
          e.geometry && e.geometry.dispose(),
            e.material && et(e.material),
            e.texture && e.texture.dispose(),
            e.children && e.children.forEach(ea);
        },
        el = function (e) {
          if (e && e.children)
      ...
      function eo(e, t) {
        var a =
          ...
          r = 100 * (1 + a);
        return {
          x: r * Math.sin(l) * Math.cos(n),
          y: r * Math.cos(l),
          z: r * Math.sin(l) * Math.sin(n),
        };
      }
      function ei(e) {
        var t = e.x,
          a = e.y,
          l = e.z,
          n = Math.sqrt(t * t + a * a + l * l),
          r = Math.atan2(l, t);
        return {
          lat: 90 - (180 * Math.acos(a / n)) / Math.PI,
          lng: 90 - (180 * r) / Math.PI - (r < -Math.PI / 2 ? 360 : 0),
          altitude: n / 100 - 1,
        };
      }
      function eq(e) {
      ...
      var eu = window.THREE
          ...
          : {
              BackSide: l.BackSide,
              BufferAttribute: l.BufferAttribute,
              Color: l.Color,
              Mesh: l.Mesh,
              ShaderMaterial: l.ShaderMaterial,
            },
        em = (function (e) {
          function t(e) {
            var a,
            ...
            var d = (function (e, t) {
                for (
                  ...
                  var o = e.attributes.normal.array[n],
                    i = e.attributes.position.array[n];
                  l[n] = i + o * t;
                }
                return (
                  a.setAttribute("position", new eu.BufferAttribute(l, 3)), a
                );
              })(e, void 0 === u ? 2 : u),
              p =
                ((a = void 0 === m ? 0.5 : m),
                ...
                new eu.ShaderMaterial({
                  ...
                  uniforms: {
                    coefficient: { value: a },
                    color: { value: new eu.Color(l) },
                    power: { value: n },
                    hollowRadius: { value: r },
                  },
                }));
            return (
              (void 0 === h || h) && (p.side = eu.BackSide),
              (o.geometry = d),
              (o.material = p),
              o
            );
        ...
        es = window.THREE
          ...
          : {
              Color: l.Color,
              LineBasicMaterial: l.LineBasicMaterial,
              LineSegments: l.LineSegments,
              Mesh: l.Mesh,
              MeshPhongMaterial: l.MeshPhongMaterial,
              SphereGeometry: l.SphereGeometry,
              SRGBColorSpace: l.SRGBColorSpace,
              TextureLoader: l.TextureLoader,
            },
        ec = (0, n.A)({
          props: {
            globeImageUrl: {},
          ...
          methods: {
            ...
            _destructor: function (e) {
              el(e.globeObj), el(e.graticulesObj);
            },
          },
          stateInit: function () {
            var e = new es.SphereGeometry(100, 75, 75),
              t = new es.MeshPhongMaterial({ color: 0 }),
              a = new es.Mesh(e, t);
            return (
              (a.rotation.y = -Math.PI / 2),
              (a.__globeObjType = "globe"),
              {
                globeObj: a,
                graticulesObj: new es.LineSegments(
                  new o.A((0, i.q)(), 100, 2),
                  new es.LineBasicMaterial({
                    color: "lightgrey",
                    transparent: !0,
                    opacity: 0.1,
                  })
                ),
                defaultGlobeMaterial: t,
              }
            );
          },
          init: function (e, t) {
          ...
          update: function (e, t) {
            var a = e.globeObj.material;
            if (
              (t.hasOwnProperty("globeImageUrl") &&
                (e.globeImageUrl
                  ? new es.TextureLoader().load(e.globeImageUrl, function (t) {
                      (t.colorSpace = es.SRGBColorSpace),
                        (a.map = t),
                        (a.color = null),
                        (a.needsUpdate = !0),
                        !e.ready && (e.ready = !0) && setTimeout(e.onReady);
                    })
                  : a.color || (a.color = new es.Color(0))),
              t.hasOwnProperty("bumpImageUrl") &&
                (e.bumpImageUrl
                  ? e.bumpImageUrl &&
                    new es.TextureLoader().load(e.bumpImageUrl, function (e) {
                      (a.bumpMap = e), (a.needsUpdate = !0);
                    })
                  : ((a.bumpMap = null), (a.needsUpdate = !0))),
              (t.hasOwnProperty("atmosphereColor") ||
                t.hasOwnProperty("atmosphereAltitude")) &&
                (e.atmosphereObj &&
                  (e.scene.remove(e.atmosphereObj), el(e.atmosphereObj)),
                e.atmosphereColor && e.atmosphereAltitude))
            ) {
              var l = (e.atmosphereObj = new em(e.globeObj.geometry, {
                color: e.atmosphereColor,
                size: 100 * e.atmosphereAltitude,
                hollowRadius: 100,
                coefficient: 0.1,
                power: 3.5,
              }));
              (l.visible = !!e.showAtmosphere),
                (l.__globeObjType = "atmosphere"),
                e.scene.add(l);
            }
        ...
        eh = function (e) {
          return isNaN(e) ? parseInt((0, h.A)(e).toHex(), 16) : e;
        },
        ed = function (e) {
          return e && isNaN(e) ? (0, c.Ay)(e).opacity : 1;
        },
        ep = function (e) {
          var t,
            a =
          ...
          if (o) {
            ...
            (t = new l.Color(
              ...
              (r = Math.min(+s, 1));
          } else t = new l.Color(e);
          n && t.convertLinearToSRGB();
          var c = t.toArray();
          return a ? [].concat($(c), [r]) : c;
        },
        ef = window.THREE
          ? window.THREE
          : { BufferAttribute: l.BufferAttribute };
        ...
        var t =
          ...
          a =
            arguments.length > 2 && void 0 !== arguments[2]
              ? arguments[2]
              : Float32Array;
        if (1 === t) return new ef.BufferAttribute(new a(e), t);
        for (
          var l = new ef.BufferAttribute(new a(e.length * t), t),
            n = 0,
            r = e.length;
          n < r;
          n++
      ...
      var eg = new WeakMap(),
        ...
        eb = (function (e) {
          function t(e) {
            ...
            return (
              E(this, t),
              N((a = P(this, t)), "scene", void 0),
              I(a, eg, void 0),
              I(a, e_, void 0),
              I(a, ey, void 0),
              (a.scene = e),
              k(eg, a, void 0 === n ? "__data" : n),
              k(e_, a, void 0 === r ? "__threeObj" : r),
              k(ey, a, void 0 === o ? 0 : o),
              a.onRemoveObj(function () {}),
              a
            );
          }
          return (
                ...
                value: function (e) {
                  ...
                  return (
                    X(
                      ...
                      function (l, n) {
                        var r = X(t, "getData", a)([l]);
                        e(l, n);
                        var o = function () {
                          a.scene.remove(l), el(l), delete r[B(e_, a)];
                        };
                        B(ey, a) ? setTimeout(o, B(ey, a)) : o();
                      },
                    ]),
                    this
                  );
        ...
        ev = window.THREE
          ? window.THREE
          : {
              BufferGeometry: l.BufferGeometry,
              Color: l.Color,
              CylinderGeometry: l.CylinderGeometry,
              Matrix4: l.Matrix4,
              Mesh: l.Mesh,
              MeshLambertMaterial: l.MeshLambertMaterial,
              Object3D: l.Object3D,
              Vector3: l.Vector3,
            },
        ew = Object.assign({}, m),
        eA = ew.BufferGeometryUtils || ew,
        eM = (0, n.A)({
          props: {
            pointsData: { default: [] },
          ...
          init: function (e, t, a) {
            ...
            el(e),
              (t.scene = e),
              (t.tweenGroup = l),
              (t.dataMapper = new eb(e, { objBindAttr: "__threeObjPoint" }));
          },
          update: function (e, t) {
            var a = (0, s.A)(e.pointLat),
              l = (0, s.A)(e.pointLng),
              n = (0, s.A)(e.pointAltitude),
              o = (0, s.A)(e.pointRadius),
              i = (0, s.A)(e.pointColor),
              q = new ev.CylinderGeometry(1, 1, 1, e.pointResolution);
            q.applyMatrix4(new ev.Matrix4().makeRotationX(Math.PI / 2)),
              q.applyMatrix4(new ev.Matrix4().makeTranslation(0, 0, -0.5));
            var u = (2 * Math.PI * 100) / 360,
              m = {};
            if (
              (!e.pointsMerge && t.hasOwnProperty("pointsMerge") && el(e.scene),
              (e.dataMapper.scene = e.pointsMerge
                ? new ev.Object3D()
                : e.scene),
              e.dataMapper
                .onCreateObj(function () {
                  var e = new ev.Mesh(q);
                  return (e.__globeObjType = "point"), e;
                })
                .onUpdateObj(function (t, q) {
                  var s = function (a) {
                      var l = (t.__currentTargetD = a),
                        n = l.r,
                        r = l.alt,
                        o = l.lat,
                        i = l.lng;
                      Object.assign(t.position, eo(o, i));
                      var q = e.pointsMerge
                        ? new ev.Vector3(0, 0, 0)
                        : e.scene.localToWorld(new ev.Vector3(0, 0, 0));
                      t.lookAt(q),
                        (t.scale.x = t.scale.y = Math.min(30, n) * u),
                        (t.scale.z = Math.max(100 * r, 0.1));
                    },
                    c = { alt: +n(q), r: +o(q), lat: +a(q), lng: +l(q) },
                    h =
                      t.__currentTargetD ||
                      Object.assign({}, c, { alt: -0.001 });
                  if (
                    (Object.keys(c).some(function (e) {
                      ...
                      e.pointsTransitionDuration < 0
                        ...
                        : e.tweenGroup.add(
                            new r.K(h)
                              .to(c, e.pointsTransitionDuration)
                              .easing(r.GS.Quadratic.InOut)
                              .onUpdate(s)
                              .start()
                          )),
                    !e.pointsMerge)
                    ...
                    (t.visible = f),
                      f &&
                        (m.hasOwnProperty(d) ||
                          (m[d] = new ev.MeshLambertMaterial({
                            color: eh(d),
                            transparent: p < 1,
                            opacity: p,
                          })),
              ...
              var c = e.pointsData.length
                  ? (eA.mergeGeometries || eA.mergeBufferGeometries)(
                      e.pointsData.map(function (t) {
                        var a = e.dataMapper.getObj(t),
                          l = a.geometry.clone();
                        a.updateMatrix(), l.applyMatrix4(a.matrix);
                        var n = ep(i(t));
                        return (
                          l.setAttribute(
                            "color",
                            ex(
                              Array(l.getAttribute("position").count).fill(n),
                              4
                            )
                          ),
                          l
                  ...
                  : new ev.BufferGeometry(),
                h = new ev.Mesh(
                  c,
                  new ev.MeshLambertMaterial({
                    color: 0xffffff,
                    transparent: !0,
                    vertexColors: !0,
                  })
                );
              (h.__globeObjType = "points"),
                (h.__data = e.pointsData),
                e.dataMapper.clear(),
                el(e.scene),
                e.scene.add(h);
            }
        ...
        eT = function (e) {
          return (
            (e.uniforms.surfaceRadius = { type: "float", value: 0 }),
            (e.vertexShader = (
        ...
        eC = function (e, t) {
          return (
            (e.onBeforeCompile = function (a) {
              e.userData.shader = t(a);
            }),
            e
          );
        },
        eD = function (e) {
          ...
          if (e.userData.shader) t(e.userData.shader.uniforms);
          else {
            var a = e.onBeforeCompile;
        ...
        eR = window.THREE
          ...
          : {
              BufferGeometry: l.BufferGeometry,
              CubicBezierCurve3: l.CubicBezierCurve3,
              Curve: l.Curve,
              Group: l.Group,
              Line: l.Line,
              Mesh: l.Mesh,
              NormalBlending: l.NormalBlending,
              QuadraticBezierCurve3: l.QuadraticBezierCurve3,
              ShaderMaterial: l.ShaderMaterial,
              TubeGeometry: l.TubeGeometry,
              Vector3: l.Vector3,
            },
        eL = p.default || p,
        eP = (0, n.A)({
          ...
          methods: {
            pauseAnimation: function (e) {
              var t;
              null === (t = e.ticker) || void 0 === t || t.pause();
            },
            resumeAnimation: function (e) {
              var t;
              null === (t = e.ticker) || void 0 === t || t.resume();
            },
            _destructor: function (e) {
              var t;
              e.sharedMaterial.dispose(),
                null === (t = e.ticker) || void 0 === t || t.dispose();
            },
          },
          stateInit: function (e) {
            return {
              tweenGroup: e.tweenGroup,
              ticker: new eL(),
              sharedMaterial: new eR.ShaderMaterial(
                K(
                  K({}, eO()),
                  {},
                  { transparent: !0, blending: eR.NormalBlending }
                )
              ),
            };
          },
          init: function (e, t) {
            el(e),
              (t.scene = e),
              (t.dataMapper = new eb(e, {
                objBindAttr: "__threeObjArc",
              }).onCreateObj(function () {
                var e = new eR.Group();
                return (e.__globeObjType = "arc"), e;
              })),
              t.ticker.onTick.add(function (e, a) {
                t.dataMapper
                  .entries()
                  .map(function (e) {
                    return Y(e, 2)[1];
                  ...
                  .filter(function (e) {
                    return (
                      e.children.length &&
                      e.children[0].material &&
                      e.children[0].__dashAnimateStep
                    );
                  })
                  .forEach(function (e) {
                    var t = e.children[0],
                      l = t.__dashAnimateStep * a,
                      n = t.material.uniforms.dashTranslate.value % 1e9;
                    t.material.uniforms.dashTranslate.value = n + l;
                  });
              });
          },
          update: function (e) {
            var t = (0, s.A)(e.arcStartLat),
              a = (0, s.A)(e.arcStartLng),
              l = (0, s.A)(e.arcEndLat),
              n = (0, s.A)(e.arcEndLng),
              o = (0, s.A)(e.arcAltitude),
              i = (0, s.A)(e.arcAltitudeAutoScale),
              m = (0, s.A)(e.arcStroke),
              c = (0, s.A)(e.arcColor),
              h = (0, s.A)(e.arcDashLength),
              d = (0, s.A)(e.arcDashGap),
              p = (0, s.A)(e.arcDashInitialGap),
              x = (0, s.A)(e.arcDashAnimateTime);
            e.dataMapper
              .onUpdateObj(function (s, g) {
                var _ = m(g),
                  y = null != _;
                if (
                  !s.children.length ||
                  y !== ("Mesh" === s.children[0].type)
                ) {
                  el(s);
                  var b = y
                    ? new eR.Mesh()
                    : new eR.Line(new eR.BufferGeometry());
                  (b.material = e.sharedMaterial.clone()), s.add(b);
                }
                var v = s.children[0];
                Object.assign(v.material.uniforms, {
                  dashSize: { value: h(g) },
                  gapSize: { value: d(g) },
                  dashOffset: { value: p(g) },
                });
                var w = x(g);
                v.__dashAnimateStep = w > 0 ? 1e3 / w : 0;
                var A = (function (e, t) {
                    var a,
                      l =
                        arguments.length > 2 && void 0 !== arguments[2]
                          ? arguments[2]
                          : 1;
                    if (e instanceof Array || e instanceof Function) {
                      var n =
                        e instanceof Array
                          ? (0, f.A)()
                              .domain(
                    ...
                    for (var o = [], i = 0, q = t + 1; i < q; i++)
                      for (var u = a(i / (q - 1)), m = 0; m < l; m++) o.push(u);
                    return ex(o, 4);
                  })(
                    c(g),
                    e.arcCurveResolution,
                    y ? e.arcCircularResolution + 1 : 1
                  ),
                  M = (function (e) {
                    for (
                      var t =
                      ...
                      for (var o = n / (r - 1), i = 0; i < t; i++) l.push(o);
                    return a && l.reverse(), ex(l, 1);
                  })(
                    e.arcCurveResolution,
                    y ? e.arcCircularResolution + 1 : 1,
                    !0
                  );
                v.geometry.setAttribute("color", A),
                  v.geometry.setAttribute("relDistance", M);
                var O = function (t) {
                    var a = (s.__currentTargetD = t),
                      l = a.stroke,
                      n = (function (e) {
                        var t = e.alt,
                          a = e.altAutoScale,
                          ...
                          i = function (e) {
                            var t = Y(e, 3),
                              ...
                              r = l.y,
                              o = l.z;
                            return new eR.Vector3(n, r, o);
                          },
                          m = [n, l],
                          s = [o, r],
                          c = t;
                        if ((null == c && (c = ((0, q.A)(m, s) / 2) * a), !c))
                          return function (e, t) {
                            var a = e.angleTo(t),
                              l =
                                0 === a
                                  ...
                                  : function (l) {
                                      return new eR.Vector3()
                                        .addVectors(
                                          ...
                                          t
                                            .clone()
                                            .multiplyScalar(Math.sin(l * a))
                                        )
                                        .divideScalar(Math.sin(a));
                                    },
                              n = new eR.Curve();
                            return (n.getPoint = l), n;
                          }.apply(
                            void 0,
                            $(
                              [
                        ...
                        var h = (0, u.A)(m, s),
                          d = Y(
                            [0.25, 0.75].map(function (e) {
                              return [].concat($(h(e)), [1.5 * c]);
                            }),
                            2
                          ),
                          p = d[0],
                          f = d[1];
                        return U(eR.CubicBezierCurve3, $([m, p, f, s].map(i)));
                      })(
                        (function (e, t) {
                          if (null == e) return {};
                          var a,
                    ...
                    y
                      ? (v.geometry && v.geometry.dispose(),
                        (v.geometry = new eR.TubeGeometry(
                          n,
                          e.arcCurveResolution,
                          l / 2,
                        ...
                        v.geometry.setAttribute("color", A),
                        v.geometry.setAttribute("relDistance", M))
                      : v.geometry.setFromPoints(
                          n.getPoints(e.arcCurveResolution)
                        );
                  },
                  T = {
                    stroke: _,
                  ...
                  j =
                    s.__currentTargetD ||
                    Object.assign({}, T, { altAutoScale: -0.001 });
        ...
        eG = window.THREE
          ...
          : {
              BufferGeometry: l.BufferGeometry,
              Color: l.Color,
              DoubleSide: l.DoubleSide,
              Mesh: l.Mesh,
              MeshLambertMaterial: l.MeshLambertMaterial,
              Object3D: l.Object3D,
            },
        eE = Object.assign({}, m),
        eB = eE.BufferGeometryUtils || eE,
        eI = (0, n.A)({
          props: {
          ...
          init: function (e, t, a) {
            ...
            el(e),
              (t.scene = e),
              (t.tweenGroup = l),
              (t.dataMapper = new eb(e, { objBindAttr: "__threeObjHexbin" }));
          },
          update: function (e, t) {
            var a = (0, s.A)(e.hexBinPointLat),
              l = (0, s.A)(e.hexBinPointLng),
              n = (0, s.A)(e.hexBinPointWeight),
              o = (0, s.A)(e.hexAltitude),
              i = (0, s.A)(e.hexTopColor),
              q = (0, s.A)(e.hexSideColor),
              u = (0, s.A)(e.hexMargin),
              m = Object.entries(
                (0, _.A)(
                  e.hexBinPointsData.map(function (t) {
                    return K(
                      K({}, t),
                      {},
                      { h3Idx: (0, y.Sg)(a(t), l(t), e.hexBinResolution) }
                    );
                  }),
                  "h3Idx"
                )
                ...
                return {
                  h3Idx: a,
                  points: l,
                  sumWeight: l.reduce(function (e, t) {
                    return e + +n(t);
                  }, 0),
                };
              }),
              c = {};
            if (
              (!e.hexBinMerge && t.hasOwnProperty("hexBinMerge") && el(e.scene),
              (e.dataMapper.scene = e.hexBinMerge
                ? new eG.Object3D()
                : e.scene),
              e.dataMapper
                .id(function (e) {
                ...
                .onCreateObj(function (e) {
                  var t = new eG.Mesh();
                  (t.__hexCenter = (0, y._k)(e.h3Idx)),
                    (t.__hexGeoJson = (0, y.u$)(e.h3Idx, !0).reverse());
                  var a = t.__hexCenter[1];
                  return (
                    t.__hexGeoJson.forEach(function (e) {
                      var t = e[0];
                      Math.abs(a - t) > 170 && (e[0] += a > t ? 360 : -360);
                    }),
                    (t.__globeObjType = "hexbin"),
                    t
                  );
                })
                .onUpdateObj(function (t, a) {
                  var l = Math.max(0, Math.min(1, +u(a))),
                    n = Y(t.__hexCenter, 2),
                    m = n[0],
                    s = n[1],
                    h =
                  ...
                  t.geometry && t.geometry.dispose(),
                    (t.geometry = new g.A([h], 0, 100, !1, !0, !0, d));
                  var p = { alt: +o(a) },
                    f = function (e) {
                      var a = (t.__currentTargetD = e).alt;
                      (t.scale.x = t.scale.y = t.scale.z = 1 + a),
                        t.geometry.setAttribute(
                          "surfaceRadius",
                          ex(
                            Array(
                              t.geometry.getAttribute("position").count
                            ).fill(100 / (a + 1)),
                            1
                          )
                        );
                  ...
                  if (
                    ...
                    var _ = q(a),
                      y = i(a);
                    [_, y].forEach(function (e) {
                      if (!c.hasOwnProperty(e)) {
                        var t = ed(e);
                        c[e] = eC(
                          new eG.MeshLambertMaterial({
                            color: eh(e),
                            transparent: t < 1,
                            opacity: t,
                            side: eG.DoubleSide,
              ...
              var h = m.length
                  ? (eB.mergeGeometries || eB.mergeBufferGeometries)(
                      m.map(function (t) {
                        var a = e.dataMapper.getObj(t),
                          l = a.geometry.toNonIndexed();
                        a.updateMatrix(), l.applyMatrix4(a.matrix);
                        var n = ep(i(t)),
                          r = ep(q(t)),
                          o = l.getAttribute("position").count,
                          u = l.groups[0].count;
                        return (
                          l.setAttribute(
                            "color",
                            ex(
                              $(Array(o)).map(function (e, t) {
                                return t >= u ? n : r;
                              }),
                              4
                            )
                  ...
                  : new eG.BufferGeometry(),
                d = new eG.MeshLambertMaterial({
                  color: 0xffffff,
                  transparent: !0,
                  vertexColors: !0,
                  side: eG.DoubleSide,
                });
              d.onBeforeCompile = function (e) {
                d.userData.shader = eT(e);
              };
              var p = new eG.Mesh(h, d);
              (p.__globeObjType = "hexBinPoints"),
                (p.__data = m),
                e.dataMapper.clear(),
                el(e.scene),
                e.scene.add(p);
          ...
          return (0, v.A)(
            n.map(function (e) {
              ...
              var f =
                ...
                (r = function (e) {
                  return ek(Math.sin(e / 2));
                }),
                (o = n(h[1])),
                (q = n(t[1])),
                (m = n(h[0])),
                (c = n(t[0])),
                2 * Math.asin(a(r(q - o) + l(o) * l(q) * r(c - m))));
              return (Math.exp(-ek(f / d) / 2) / (d * eU)) * p;
            })
          );
        },
        eN = window.THREE
          ...
          function e(t, a) {
            E(this, e),
              ...
              k(
                eW,
                this,
                L(eV, this, eK).call(this, eo(0, 0), eo(0, Math.min(180, a)))
              );
          },
          [
            {
              ...
              value: function (e, t, a) {
                var l = this;
                return B(ez, this)
                  .intersectSphere(e, t, a, B(eW, this))
                  .map(function (e) {
                    return B(eF, l)[e / 3];
                  });
              },
      ...
      var eQ = function (e) {
        ...
        eY = (0, n.A)({
          ...
          init: function (e, t, a) {
            ...
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var e = new eN.Mesh(
                  new eN.SphereGeometry(100),
                  eC(
                    new eN.MeshLambertMaterial({
                      vertexColors: !0,
                      transparent: !0,
                    }),
                    ej
          ...
          update: function (e) {
            var t = (0, s.A)(e.heatmapPoints),
              a = (0, s.A)(e.heatmapPointLat),
              l = (0, s.A)(e.heatmapPointLng),
              n = (0, s.A)(e.heatmapPointWeight),
              o = (0, s.A)(e.heatmapBandwidth),
              i = (0, s.A)(e.heatmapColorFn),
              q = (0, s.A)(e.heatmapColorSaturation),
              u = (0, s.A)(e.heatmapBaseAltitude),
              m = (0, s.A)(e.heatmapTopAltitude);
            e.dataMapper
              .onUpdateObj(function (s, c) {
                var h = o(c),
                  d = i(c),
                  p = q(c),
                  g = u(c),
                  _ = m(c),
                  y = t(c).map(function (e) {
                    var t = a(e),
                      r = l(e),
                      o = eo(t, r);
                    return {
                  ...
                  b = Math.ceil(360 / (Math.max(0.1, h / 3.5) || -1));
                s.geometry.parameters.widthSegments !== b &&
                  (s.geometry.dispose(),
                  (s.geometry = new eN.SphereGeometry(100, b, b / 2)));
                var v = (function (e) {
                    for (var t = e.itemSize, a = [], l = 0; l < e.count; l++)
                      a.push(e.array.slice(l * t, (l + 1) * t));
                    return a;
                  })(s.geometry.getAttribute("position")),
                  A = v.map(function (e) {
                    var t = Y(e, 3),
                      a = ei({ x: t[0], y: t[1], z: t[2] });
                    return [a.lng, a.lat];
                  }),
                  M = new eJ(y, 3.5 * h),
                  O = A.map(function (e, t) {
                    var a = Y(v[t], 3),
                      ...
                      n = a[1],
                      r = a[2];
                    return eH(e, M.getNearPoints(l, n, r), {
                      latAccessor: function (e) {
                        return e.lat;
                      },
                      lngAccessor: function (e) {
                        return e.lng;
                      },
                      weightAccessor: function (e) {
                        return e.weight;
                      },
                      bandwidth: h,
                    });
                  }),
                  T = $(Array(100)).map(function (e, t) {
                    return ep(d(t / 99));
                  }),
                  j = function (e) {
                    var t = (s.__currentTargetD = e),
                      a = t.kdeVals,
                      l = t.topAlt,
                      n = t.saturation,
                      r = (0, w.A)(a.map(Math.abs)) || 1e-15,
                      o = (0, x.A)([0, r / n], T);
                    ...
                    s.geometry.setAttribute("r", ex(a.map(i)));
                  },
                  C = { kdeVals: O, topAlt: _, saturation: p },
                  D =
                    s.__currentTargetD ||
                    Object.assign({}, C, {
                      kdeVals: O.map(function () {
                        return 0;
                      }),
                      topAlt: _ ? g : _,
                      saturation: 0.5,
                    });
                D.kdeVals.length !== O.length && (D.kdeVals = O.slice()),
                  Object.keys(C).some(function (e) {
                    return D[e] !== C[e];
                  }) &&
                    (!e.heatmapsTransitionDuration ||
                    e.heatmapsTransitionDuration < 0
                      ? j(C)
                      : e.tweenGroup.add(
                          new r.K(D)
                            .to(C, e.heatmapsTransitionDuration)
                            .easing(r.GS.Quadratic.InOut)
                            .onUpdate(j)
                            .start()
                        ));
        ...
        eX = window.THREE
          ...
          : {
              ...
              LineSegments: l.LineSegments,
              Mesh: l.Mesh,
              MeshBasicMaterial: l.MeshBasicMaterial,
            },
        e$ = (0, n.A)({
          props: {
          ...
          init: function (e, t, a) {
            ...
            el(e),
              (t.scene = e),
              (t.tweenGroup = l),
              (t.dataMapper = new eb(e, { objBindAttr: "__threeObjPolygon" })
                .id(function (e) {
                  return e.id;
                })
                .onCreateObj(function () {
                  var e = new eX.Group();
                  return (
                    (e.__defaultSideMaterial = eC(
                      new eX.MeshBasicMaterial({
                        side: eX.DoubleSide,
                        depthWrite: !0,
                      }),
                      eT
                    )),
                    (e.__defaultCapMaterial = new eX.MeshBasicMaterial({
                      side: eX.DoubleSide,
                      depthWrite: !0,
                    })),
                    e.add(
                      new eX.Mesh(void 0, [
                        e.__defaultSideMaterial,
                        e.__defaultCapMaterial,
                      ])
                    ),
                    e.add(
                      new eX.LineSegments(void 0, new eX.LineBasicMaterial())
                    ),
                    (e.__globeObjType = "polygon"),
                    e
                  );
                }));
          },
          update: function (e) {
            var t = (0, s.A)(e.polygonGeoJsonGeometry),
              a = (0, s.A)(e.polygonAltitude),
              l = (0, s.A)(e.polygonCapCurvatureResolution),
              n = (0, s.A)(e.polygonCapColor),
              i = (0, s.A)(e.polygonCapMaterial),
              q = (0, s.A)(e.polygonSideColor),
              u = (0, s.A)(e.polygonSideMaterial),
              m = (0, s.A)(e.polygonStrokeColor),
              c = [];
            e.polygonsData.forEach(function (e) {
              var r = {
                  data: e,
                  capColor: n(e),
                  capMaterial: i(e),
                  ...
                  strokeColor: m(e),
                  altitude: +a(e),
                  capCurvatureResolution: +l(e),
                },
                o = t(e),
                s = e.__id || "".concat(Math.round(1e9 * Math.random()));
              (e.__id = s),
                "Polygon" === o.type
                  ? c.push(
                      K({ id: "".concat(s, "_0"), coords: o.coordinates }, r)
                    )
                  : "MultiPolygon" === o.type
                  ? c.push.apply(
                      c,
                      $(
                        o.coordinates.map(function (e, t) {
                          return K(
                            { id: "".concat(s, "_").concat(t), coords: e },
                            r
                          );
                        })
                      )
              ...
              e.dataMapper
                .onUpdateObj(function (t, a) {
                  ...
                  if (
                    ...
                    !(function (e, t) {
                      ...
                      return Object.entries(t).every(function (t) {
                        var l = Y(t, 2),
                          n = l[0],
                          r = l[1];
                        return e.hasOwnProperty(n) && a(n)(e[n], r);
                      });
                      ...
                      (d.geometry = new g.A(l, 0, 100, !1, !0, !0, c))),
                    f &&
                      (!p.geometry.parameters ||
                        p.geometry.parameters.geoJson.coordinates !== l ||
                        p.geometry.parameters.resolution !== c) &&
                    ...
                    (d.material[0] = u || t.__defaultSideMaterial),
                    (d.material[1] = i || t.__defaultCapMaterial),
                    [!u && q, !i && n].forEach(function (e, t) {
                      if (e) {
                        var a = d.material[t],
                          l = ed(e);
                        a.color.set(eh(e)),
                  ...
                  var y = { alt: s },
                    b = function (e) {
                      var a = (t.__currentTargetD = e).alt;
                      (d.scale.x = d.scale.y = d.scale.z = 1 + a),
                        f && (p.scale.x = p.scale.y = p.scale.z = 1 + a + 1e-4),
                        eD(t.__defaultSideMaterial, function (e) {
                          return (e.surfaceRadius.value = 100 / (a + 1));
                        });
                    },
                    v =
                      t.__currentTargetD ||
                      Object.assign({}, y, { alt: -0.001 });
                  Object.keys(y).some(function (e) {
                    return v[e] !== y[e];
                  }) &&
                    ...
                    v.alt === y.alt
                      ...
                      : e.tweenGroup.add(
                          new r.K(v)
                            .to(y, e.polygonsTransitionDuration)
                            .easing(r.GS.Quadratic.InOut)
                            .onUpdate(b)
                            .start()
                        ));
        ...
        eZ = window.THREE
          ...
          : {
              BufferGeometry: l.BufferGeometry,
              CircleGeometry: l.CircleGeometry,
              DoubleSide: l.DoubleSide,
              Mesh: l.Mesh,
              MeshLambertMaterial: l.MeshLambertMaterial,
              Vector3: l.Vector3,
          ...
          init: function (e, t, a) {
            ...
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var e = new eZ.Mesh(
                  void 0,
                  new eZ.MeshLambertMaterial({ side: eZ.DoubleSide })
                );
                return (e.__globeObjType = "hexPolygon"), e;
              }));
          },
          update: function (e) {
            var t = (0, s.A)(e.hexPolygonGeoJsonGeometry),
              a = (0, s.A)(e.hexPolygonColor),
              n = (0, s.A)(e.hexPolygonAltitude),
              o = (0, s.A)(e.hexPolygonResolution),
              i = (0, s.A)(e.hexPolygonMargin),
              q = (0, s.A)(e.hexPolygonUseDots),
              u = (0, s.A)(e.hexPolygonCurvatureResolution),
              m = (0, s.A)(e.hexPolygonDotResolution);
            e.dataMapper
              .onUpdateObj(function (s, c) {
                var h = t(c),
                  d = o(c),
                  p = n(c),
                  f = Math.max(0, Math.min(1, +i(c))),
                  x = q(c),
                  _ = u(c),
                  b = m(c),
                  v = a(c),
                  w = ed(v);
                s.material.color.set(eh(v)),
                  (s.material.transparent = w < 1),
                  (s.material.opacity = w);
                var A = { alt: p, margin: f, curvatureResolution: _ },
                  M = { geoJson: h, h3Res: d },
                  O =
                    s.__currentTargetD || Object.assign({}, A, { alt: -0.001 }),
                  T = s.__currentMemD || M;
                if (
                  ...
                  var j = [];
                  "Polygon" === h.type
                    ? (0, y.r1)(h.coordinates, d, !0).forEach(function (e) {
                        return j.push(e);
                      })
                    : "MultiPolygon" === h.type
                    ? h.coordinates.forEach(function (e) {
                        return (0, y.r1)(e, d, !0).forEach(function (e) {
                          return j.push(e);
                        });
                      })
                    : console.warn(
                  ...
                  var C = j.map(function (e) {
                      ...
                      return (
                        a.forEach(function (e) {
                          var t = e[0];
                          Math.abs(l - t) > 170 && (e[0] += l > t ? 360 : -360);
                        }),
                        { h3Idx: e, hexCenter: t, hexGeoJson: a }
                      );
                    }),
                    D = function (e) {
                      var t = (s.__currentTargetD = e),
                        a = t.alt,
                        n = t.margin,
                        r = t.curvatureResolution;
                      s.geometry && s.geometry.dispose(),
                        (s.geometry = C.length
                          ? (e0.mergeGeometries || e0.mergeBufferGeometries)(
                              C.map(function (e) {
                                var t = Y(e.hexCenter, 2),
                                  o = t[0],
                                  i = t[1];
                                if (x) {
                                  var q = eo(o, i, a),
                                    ...
                                    m =
                                      0.85 *
                                      (1 - n) *
                                      new eZ.Vector3(q.x, q.y, q.z).distanceTo(
                                        new eZ.Vector3(u.x, u.y, u.z)
                                      ),
                                    s = new l.CircleGeometry(m, b);
                                  return (
                                    s.rotateX(eq(-o)),
                                    s.rotateY(eq(i)),
                  ...
                  e.hexPolygonsTransitionDuration < 0
                    ...
                    : e.tweenGroup.add(
                        new r.K(O)
                          .to(A, e.hexPolygonsTransitionDuration)
                          .easing(r.GS.Quadratic.InOut)
                          .onUpdate(D)
                          .start()
                      );
        ...
        e3 = window.THREE ? window.THREE : { Vector3: l.Vector3 },
        e4 = window.THREE
          ? window.THREE
          : {
              BufferGeometry: l.BufferGeometry,
        ...
        e6 = (0, n.A)({
          ...
          stateInit: function (e) {
            return {
              tweenGroup: e.tweenGroup,
              ticker: new e5(),
              sharedMaterial: new e4.ShaderMaterial(
                K(
                  K({}, eO()),
                  {},
                  { transparent: !0, blending: e4.NormalBlending }
                )
              ),
            };
          },
          init: function (e, t) {
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var e = new e4.Group();
                return (e.__globeObjType = "path"), e;
              })),
              t.ticker.onTick.add(function (e, a) {
                t.dataMapper
                  .entries()
                  ...
                  .forEach(function (e) {
                    var t = e.children[0],
                      l = t.__dashAnimateStep * a;
                    if ("Line" === t.type) {
                      var n = t.material.uniforms.dashTranslate.value % 1e9;
                      t.material.uniforms.dashTranslate.value = n + l;
                    } else if ("Line2" === t.type) {
                      for (
                        var r = t.material.dashOffset - l,
                          o = t.material.dashSize + t.material.gapSize;
                        r <= -o;

                      )
                        r += o;
                      t.material.dashOffset = r;
                    }
                  });
              });
          },
          update: function (e) {
            var t = (0, s.A)(e.pathPoints),
              a = (0, s.A)(e.pathPointLat),
              l = (0, s.A)(e.pathPointLng),
              n = (0, s.A)(e.pathPointAlt),
              o = (0, s.A)(e.pathStroke),
              i = (0, s.A)(e.pathColor),
              q = (0, s.A)(e.pathDashLength),
              u = (0, s.A)(e.pathDashGap),
              m = (0, s.A)(e.pathDashInitialGap),
              c = (0, s.A)(e.pathDashAnimateTime);
            function h(e, t) {
              var a,
                l =
                  arguments.length > 2 && void 0 !== arguments[2]
              ...
              for (var i = [], q = 0, u = t + 1; q < u; q++)
                for (var m = a(q / (u - 1)), s = 0; s < l; s++) i.push(m);
              return ex(i, n ? 4 : 3);
            }
            e.dataMapper
              .onUpdateObj(function (s, d) {
                var p,
                  f,
                  x,
                  g,
                ...
                if (
                  !s.children.length ||
                  y === ("Line" === s.children[0].type)
                ) {
                  el(s);
                  var b = y
                    ? new M.X(new O.v(), new T.G())
                    : new e4.Line(
                        new e4.BufferGeometry(),
                  ...
                  w =
                    ...
                    (function () {
                      ...
                      var t = Y(e, 3),
                        ...
                        n = a.y,
                        r = a.z;
                      return new e4.Vector3(l, n, r);
                    })),
                  A = c(d);
                if (((v.__dashAnimateStep = A > 0 ? 1e3 / A : 0), y)) {
                  v.material.resolution = e.rendererSize;
                  var C,
                    D,
                    S,
                    R,
                    ...
                    G = u(d),
                    E = m(d);
                  (v.material.dashed = G > 0),
                    v.material.dashed
                      ? (v.material.defines.USE_DASH = "")
                      : delete v.material.defines.USE_DASH,
                    v.material.dashed &&
                      ((v.material.dashScale =
                        1 /
                        ((L = 0),
                        w.forEach(function (e) {
                          R && (L += R.distanceTo(e)), (R = e);
                        }),
                        L)),
                      (v.material.dashSize = P),
                      (v.material.gapSize = G),
                      (v.material.dashOffset = -E));
                  var B = i(d);
                  if (B instanceof Array) {
                    var I = h(i(d), w.length - 1, 1, !1);
                    v.geometry.setColors(I.array),
                      (v.material.vertexColors = !0);
                  } else {
                    var k = ed(B);
                    (v.material.color = new e4.Color(eh(B))),
                      (v.material.transparent = k < 1),
                      (v.material.opacity = k),
                      (v.material.vertexColors = !1);
                  }
                  ...
                  Object.assign(v.material.uniforms, {
                    dashSize: { value: q(d) },
                    gapSize: { value: u(d) },
                    dashOffset: { value: m(d) },
                  });
                  var U = h(i(d), w.length),
                    H = (function (e) {
                      for (
                        var t =
                            arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  v.geometry.setAttribute("color", U),
                    v.geometry.setAttribute("relDistance", H);
                }
                var N =
                    ((p = (s.__currentTargetD && s.__currentTargetD.points) || [
                      w[0],
                    ]),
                    (f = function (e, t) {
                      var a = e[e.length - 1];
                      return [].concat($(e), $(Array(t - e.length).fill(a)));
                    }),
                    (x = Math.max(p.length, w.length)),
                    (g = j.A.apply(
                      void 0,
                      $(
                        [p, w]
                      ...
                      return 0 === e
                        ...
                        : g(e).map(function (e) {
                            var t = Y(e, 3),
                              ...
                              l = t[1],
                              n = t[2];
                            return new e3.Vector3(a, l, n);
                          });
                    }),
                  V = function (e) {
                    var t,
                      a = (s.__currentTargetD = e),
                      l = a.stroke,
                      n = a.interpolK,
                      r = (s.__currentTargetD.points = N(n));
                    y
                      ? (v.geometry.setPositions(
                          (t = []).concat.apply(
                            t,
                            $(
                              r.map(function (e) {
                        ...
                        (v.material.linewidth = l),
                        v.material.dashed && v.computeLineDistances())
                      : (v.geometry.setFromPoints(r),
                        v.geometry.computeBoundingSphere());
                  },
                  F = { stroke: _, interpolK: 1 },
                  z = Object.assign({}, s.__currentTargetD || F, {
                    interpolK: 0,
                  });
        ...
        e8 = (0, n.A)({
          props: {
            ...
            tileMaterial: {
              default: function () {
                return new e7.MeshLambertMaterial({
                  color: "#ffbb88",
                  opacity: 0.4,
                  transparent: !0,
                });
          ...
          init: function (e, t, a) {
            ...
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var e = new e7.Mesh();
                return (e.__globeObjType = "tile"), e;
              }));
          },
          update: function (e) {
            var t = (0, s.A)(e.tileLat),
              a = (0, s.A)(e.tileLng),
              l = (0, s.A)(e.tileAltitude),
              n = (0, s.A)(e.tileWidth),
              o = (0, s.A)(e.tileHeight),
              i = (0, s.A)(e.tileUseGlobeProjection),
              q = (0, s.A)(e.tileMaterial),
              u = (0, s.A)(e.tileCurvatureResolution);
            e.dataMapper
              .onUpdateObj(function (m, s) {
                m.material = q(s);
                var c = i(s),
                  h = u(s),
                  d = function (e) {
                    var t = (m.__currentTargetD = e),
                      a = t.lat,
                      l = t.lng,
                      n = t.alt,
                      r = t.width,
                    ...
                    m.geometry && m.geometry.dispose(),
                      (m.geometry = new e7.SphereGeometry(
                        100 * (1 + n),
                        Math.ceil(r / (h || -1)),
                        Math.ceil(o / (h || -1)),
                        e9(90 - r / 2) + (c ? i : 0),
                      ...
                      c || m.setRotationFromEuler(new e7.Euler(q, i, 0, "YXZ"));
                  },
                  p = {
                    lat: +t(s),
                    lng: +a(s),
                  ...
                  f =
                    m.__currentTargetD ||
                    Object.assign({}, p, { width: 0, height: 0 });
                Object.keys(p).some(function (e) {
                  return f[e] !== p[e];
                }) &&
                  (!e.tilesTransitionDuration || e.tilesTransitionDuration < 0
                    ...
                    : e.tweenGroup.add(
                        new r.K(f)
                          .to(p, e.tilesTransitionDuration)
                          .easing(r.GS.Quadratic.InOut)
                          .onUpdate(d)
                          .start()
                      ));
        ...
        tt = (0, n.A)({
          ...
          init: function (e, t, a) {
            var n = a.tweenGroup;
            el(e), (t.scene = e), (t.tweenGroup = n);
            var r = new te.CircleGeometry(1, 32);
            t.dataMapper = new eb(e, {
              objBindAttr: "__threeObjLabel",
            }).onCreateObj(function () {
              var e = new te.MeshLambertMaterial();
              e.side = l.DoubleSide;
              var t = new te.Group();
              t.add(new te.Mesh(r, e));
              var a = new te.Mesh(void 0, e);
              t.add(a);
              var n = new te.Mesh();
              return (
                (n.visible = !1), a.add(n), (t.__globeObjType = "label"), t
              );
            });
          },
          update: function (e) {
            var t = (0, s.A)(e.labelLat),
              a = (0, s.A)(e.labelLng),
              l = (0, s.A)(e.labelAltitude),
              n = (0, s.A)(e.labelText),
              o = (0, s.A)(e.labelSize),
              i = (0, s.A)(e.labelRotation),
              q = (0, s.A)(e.labelColor),
              u = (0, s.A)(e.labelIncludeDot),
              m = (0, s.A)(e.labelDotRadius),
              c = (0, s.A)(e.labelDotOrientation),
              h = new Set(["right", "top", "bottom"]),
              d = (2 * Math.PI * 100) / 360;
            e.dataMapper
              .onUpdateObj(function (s, p) {
                var f = Y(s.children, 2),
                  x = f[0],
                  g = f[1],
                  _ = Y(g.children, 1)[0],
                  y = q(p),
                  b = ed(y);
                g.material.color.set(eh(y)),
                  (g.material.transparent = b < 1),
                  (g.material.opacity = b);
                var v = u(p),
                  w = c(p);
                v && (h.has(w) || (w = "bottom"));
                var A = v ? +m(p) * d : 1e-12;
                x.scale.x = x.scale.y = A;
                var M = +o(p) * d;
                if (
                  (g.geometry && g.geometry.dispose(),
                  (g.geometry = new te.TextGeometry(n(p), {
                    font: e.font,
                    size: M,
                    depth: 0,
                    height: 0,
                  ...
                  (_.geometry = U(
                    ...
                    $(
                      new te.Vector3()
                        .subVectors(
                          g.geometry.boundingBox.max,
                          g.geometry.boundingBox.min
                        )
                        .toArray()
                    )
                  )),
                  "right" !== w && g.geometry.center(),
                  v)
                ) {
                  var O = A + M / 2;
                  "right" === w && (g.position.x = O),
                    (g.position.y = {
                      right: -M / 2,
                      top: O + M / 2,
                      bottom: -O - M / 2,
                ...
                var T = function (t) {
                    var a = (s.__currentTargetD = t),
                      ...
                      o = a.rot,
                      i = a.scale;
                    Object.assign(s.position, eo(l, n, r)),
                      s.lookAt(e.scene.localToWorld(new te.Vector3(0, 0, 0))),
                      s.rotateY(Math.PI),
                      s.rotateZ((-o * Math.PI) / 180),
                      (s.scale.x = s.scale.y = s.scale.z = i);
                  },
                  j = {
                    lat: +t(p),
                    lng: +a(p),
                  ...
                  C =
                    s.__currentTargetD ||
                    Object.assign({}, j, { scale: 1e-12 });
                Object.keys(j).some(function (e) {
                  return C[e] !== j[e];
                }) &&
                  (!e.labelsTransitionDuration || e.labelsTransitionDuration < 0
                    ...
                    : e.tweenGroup.add(
                        new r.K(C)
                          .to(j, e.labelsTransitionDuration)
                          .easing(r.GS.Quadratic.InOut)
                          .onUpdate(T)
                          .start()
                      ));
            ...
            var e,
              ...
              l =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : 32;
            E(this, t),
              ((e = P(this, t)).type = "CircleLineGeometry"),
              (e.parameters = { radius: a, segmentCount: l });
            for (var n = [], r = 0; r <= l; r++) {
              var o = (r / l - 0.25) * Math.PI * 2;
              n.push({ x: Math.cos(o) * a, y: Math.sin(o) * a, z: 0 });
            }
            return e.setFromPoints(n), e;
          }
          return z(t, e), H(t);
        })(
          (window.THREE ? window.THREE : { BufferGeometry: l.BufferGeometry })
            .BufferGeometry
        ),
        tl = window.THREE
          ? window.THREE
        ...
        tr = (0, n.A)({
          ...
          init: function (e, t, a) {
            ...
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var e = new tl.Group();
                return (e.__globeObjType = "ring"), e;
              })),
              (t.ticker = new tn()),
              t.ticker.onTick.add(function (e) {
                if (t.ringsData.length) {
                  var a = (0, s.A)(t.ringColor),
                    l = (0, s.A)(t.ringAltitude),
                    n = (0, s.A)(t.ringMaxRadius),
                    o = (0, s.A)(t.ringPropagationSpeed),
                    i = (0, s.A)(t.ringRepeatPeriod);
                  t.dataMapper
                    .entries()
                    .filter(function (e) {
                      return Y(e, 2)[1];
                    ...
                    .forEach(function (q) {
                      var u = Y(q, 2),
                        m = u[0],
                        s = u[1];
                      if ((s.__nextRingTime || 0) <= e) {
                        var c,
                          h,
                          d,
                          p = i(m) / 1e3;
                        s.__nextRingTime = e + (p <= 0 ? 1 / 0 : p);
                        var x = new tl.Line(
                            new ta(1, t.ringResolution),
                            new tl.LineBasicMaterial()
                          ),
                          g = a(m),
                          _ = g instanceof Array || g instanceof Function;
                        _
                          ? g instanceof Array
                            ? ((d = (0, f.A)()
                                .domain(
                                ...
                                .range(g)),
                              (x.material.transparent = g.some(function (e) {
                                return 1 > ed(e);
                              })))
                            : ((d = g), (x.material.transparent = !0))
                          : ((x.material.color = new tl.Color(eh(g))),
                            (c = x.material),
                            (h = ed(g)),
                            (c.opacity = h),
                            (c.transparent = h < 1),
                        ...
                        var y = 100 * (1 + l(m)),
                          ...
                          M = function (e) {
                            var t = e.t,
                              a = (A ? 1 - t : t) * v;
                            if (
                              ((x.scale.x = x.scale.y = y * Math.sin(a)),
                              (x.position.z = y * (1 - Math.cos(a))),
                              _)
                            ) {
                              var l = d(t);
                              (x.material.color = new tl.Color(eh(l))),
                                x.material.transparent &&
                                  (x.material.opacity = ed(l));
                            }
                          };
                        if (0 === w) M({ t: 0 }), s.add(x);
                        else {
                          var O = 1e3 * Math.abs(b / w);
                          t.tweenGroup.add(
                            new r.K({ t: 0 })
                              .to({ t: 1 }, O)
                              .onUpdate(M)
          ...
          update: function (e) {
            var t = (0, s.A)(e.ringLat),
              a = (0, s.A)(e.ringLng),
              l = (0, s.A)(e.ringAltitude),
              n = new tl.Vector3(0, 0, 0);
            e.dataMapper
              .onUpdateObj(function (e, r) {
                var o = t(r),
                  i = a(r),
                  q = l(r);
                Object.assign(e.position, eo(o, i, q)), e.lookAt(n);
              })
              .digest(e.ringsData);
          },
        }),
        to = K(
          K({}, window.THREE ? window.THREE : {}),
          {},
          { CSS2DObject: S.v }
        ),
        ti = (0, n.A)({
            ...
            updateObjVisibility: function (e, t) {
              e.dataMapper &&
                (t
                  ...
                  return (t.visible =
                    !e.isBehindGlobe || !e.isBehindGlobe(t.position));
                });
            },
          },
          init: function (e, t, a) {
            ...
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var a = (0, s.A)(t.htmlElement)(e),
                  l = new to.CSS2DObject(a);
                return (l.__globeObjType = "html"), l;
              }));
          },
          update: function (e, t) {
            var a = this,
              l = (0, s.A)(e.htmlLat),
              n = (0, s.A)(e.htmlLng),
              o = (0, s.A)(e.htmlAltitude);
            t.hasOwnProperty("htmlElement") && e.dataMapper.clear(),
              e.dataMapper
                .onUpdateObj(function (t, i) {
                  var q = function (e) {
                      var l = (t.__currentTargetD = e),
                        n = l.alt,
                        r = l.lat,
                        o = l.lng;
                      Object.assign(t.position, eo(r, o, n)),
                        a.updateObjVisibility(t);
                    },
                    u = { lat: +l(i), lng: +n(i), alt: +o(i) };
                  e.htmlTransitionDuration &&
                  !(e.htmlTransitionDuration < 0) &&
                  t.__currentTargetD
                    ? e.tweenGroup.add(
                        new r.K(t.__currentTargetD)
        ...
        tu = (0, n.A)({
          props: {
            ...
            objectThreeObject: {
              default: new tq.Mesh(
                new tq.SphereGeometry(1, 16, 8),
                new tq.MeshLambertMaterial({
                  color: "#ffffaa",
                  transparent: !0,
                  opacity: 0.7,
                })
          ...
          init: function (e, t) {
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var a = (0, s.A)(t.objectThreeObject)(e);
                t.objectThreeObject === a && (a = a.clone());
                var l = new tq.Group();
                return l.add(a), (l.__globeObjType = "object"), l;
              }));
          },
          update: function (e, t) {
            var a = (0, s.A)(e.objectLat),
              n = (0, s.A)(e.objectLng),
              r = (0, s.A)(e.objectAltitude),
              o = (0, s.A)(e.objectFacesSurface),
              i = (0, s.A)(e.objectRotation);
            t.hasOwnProperty("objectThreeObject") && e.dataMapper.clear(),
              e.dataMapper
                .onUpdateObj(function (e, t) {
                  var q = +a(t),
                    u = +n(t),
                    m = +r(t);
                  Object.assign(e.position, eo(q, u, m)),
                    o(t)
                      ? e.setRotationFromEuler(
                          new l.Euler(eq(-q), eq(u), 0, "YXZ")
                        )
                      : e.rotation.set(0, 0, 0);
                  var s = e.children[0],
                    c = i(t);
                  c &&
                    s.setRotationFromEuler(
                      new l.Euler(eq(c.x || 0), eq(c.y || 0), eq(c.z || 0))
                    );
                })
        ...
        tm = (0, n.A)({
          ...
          init: function (e, t) {
            el(e),
              ...
              (t.dataMapper = new eb(e, {
                ...
                var a = (0, s.A)(t.customThreeObject)(e, 100);
                return (
                  a &&
                    (t.customThreeObject === a && (a = a.clone()),
          ...
          update: function (e, t) {
            e.customThreeObjectUpdate || el(e.scene);
            var a = (0, s.A)(e.customThreeObjectUpdate);
            t.hasOwnProperty("customThreeObject") && e.dataMapper.clear(),
              e.dataMapper
                .onUpdateObj(function (e, t) {
                  return a(e, t, 100);
                })
        ...
        ts = window.THREE
          ? window.THREE
          : { Group: l.Group, Vector2: l.Vector2, Vector3: l.Vector3 },
        tc = [
          "globeLayer",
          "pointsLayer",
          "arcsLayer",
        ...
        td = Object.assign.apply(
          ...
          $(
            [
              ...
              return N({}, e, th.linkProp(e));
            })
          )
        ),
        tp = Object.assign.apply(
          Object,
          $(
            ["globeMaterial"].map(function (e) {
              return N({}, e, th.linkMethod(e));
            })
          )
        ),
        tf = en("pointsLayer", eM),
        tx = Object.assign.apply(
          Object,
          $(
            [
              "pointsData",
              ...
              return N({}, e, tf.linkProp(e));
            })
          )
        ),
        tg = en("arcsLayer", eP),
        t_ = Object.assign.apply(
          Object,
          $(
            [
              "arcsData",
              ...
              return N({}, e, tg.linkProp(e));
            })
          )
        ),
        ty = en("hexBinLayer", eI),
        tb = Object.assign.apply(
          Object,
          $(
            [
              "hexBinPointsData",
              ...
              return N({}, e, ty.linkProp(e));
            })
          )
        ),
        tv = en("heatmapsLayer", eY),
        tw = Object.assign.apply(
          Object,
          $(
            [
              "heatmapsData",
              ...
              return N({}, e, tv.linkProp(e));
            })
          )
        ),
        tA = en("hexedPolygonsLayer", e2),
        tM = Object.assign.apply(
          Object,
          $(
            [
              "hexPolygonsData",
              ...
              return N({}, e, tA.linkProp(e));
            })
          )
        ),
        tO = en("polygonsLayer", e$),
        tT = Object.assign.apply(
          ...
          $(
            [
              ...
              return N({}, e, tO.linkProp(e));
            })
          )
        ),
        tj = en("pathsLayer", e6),
        tC = Object.assign.apply(
          Object,
          $(
            [
              "pathsData",
              ...
              return N({}, e, tj.linkProp(e));
            })
          )
        ),
        tD = en("tilesLayer", e8),
        tS = Object.assign.apply(
          Object,
          $(
            [
              "tilesData",
              ...
              return N({}, e, tD.linkProp(e));
            })
          )
        ),
        tR = en("labelsLayer", tt),
        tL = Object.assign.apply(
          Object,
          $(
            [
              "labelsData",
              ...
              return N({}, e, tR.linkProp(e));
            })
          )
        ),
        tP = en("ringsLayer", tr),
        tG = Object.assign.apply(
          Object,
          $(
            [
              "ringsData",
              ...
              return N({}, e, tP.linkProp(e));
            })
          )
        ),
        tE = en("htmlElementsLayer", ti),
        tB = Object.assign.apply(
          Object,
          $(
            [
              ...
              return N({}, e, tE.linkProp(e));
            })
          )
        ),
        tI = en("objectsLayer", tu),
        tk = Object.assign.apply(
          Object,
          $(
            [
              "objectsData",
              ...
              return N({}, e, tI.linkProp(e));
            })
          )
        ),
        tU = en("customLayer", tm),
        tH = Object.assign.apply(
          Object,
          $(
            [
              "customLayerData",
        ...
        tN = (function (e) {
            ...
            l = (function (t) {
              function l() {
                ...
                for (var n = arguments.length, r = Array(n), o = 0; o < n; o++)
                  r[o] = arguments[o];
                return (
                  ((t = P(this, l, [].concat(r))).__kapsuleInstance = U(
                    e,
                    [].concat($(a ? [t] : []), r)
                  )),
                  t
          ...
          return (
            Object.keys(e()).forEach(function (e) {
              return (l.prototype[e] = function () {
                var t,
                  a = (t = this.__kapsuleInstance)[e].apply(t, arguments);
                return a === this.__kapsuleInstance ? this : a;
              });
            }),
            l
          );
          ...
          (0, n.A)({
            ...
            methods: K(
              {
                  ...
                  if (t) {
                    ...
                    l = function (e) {
                      void 0 === n && (n = q.length()),
                        ...
                        void 0 === o && (o = Math.acos(r / n));
                      var t = q.distanceTo(e);
                      if (t < r) return !1;
                      var a = e.length();
                      return (
                        Math.acos(
                          (Math.pow(n, 2) + Math.pow(t, 2) - Math.pow(a, 2)) /
                            (2 * n * t)
                        ) < o
                      );
                    };
                  }
                  e.layersThatNeedBehindGlobeChecker.forEach(function (e) {
                    return e.isBehindGlobe(l);
                  });
                },
                pauseAnimation: function (e) {
                  return (
                    ...
                    e.pausableLayers.forEach(function (e) {
                      var t;
                      return null === (t = e.pauseAnimation) || void 0 === t
                        ? void 0
                        : t.call(e);
                    }),
                    this
                ...
                resumeAnimation: function (e) {
                  return (
                    ...
                    e.pausableLayers.forEach(function (e) {
                      var t;
                      return null === (t = e.resumeAnimation) || void 0 === t
                        ? void 0
                        : t.call(e);
                    }),
                    this
                ...
                _destructor: function (e) {
                  this.pauseAnimation(),
                    e.destructableLayers.forEach(function (e) {
                      return e._destructor();
                    });
                },
              },
              tp
            ...
            stateInit: function () {
              var e = new r.YJ(),
                ...
                a = {
                  ...
                  heatmapsLayer: eY(t),
                  polygonsLayer: e$(t),
                  hexedPolygonsLayer: e2(t),
                  pathsLayer: e6(t),
                  tilesLayer: e8(t),
                  labelsLayer: tt(t),
                  ringsLayer: tr(t),
                  htmlElementsLayer: ti(t),
                  objectsLayer: tu(t),
                  customLayer: tm(t),
                };
              return K(
                ...
                {},
                {
                  layersThatNeedBehindGlobeChecker: Object.values(a).filter(
                    function (e) {
                      return e.hasOwnProperty("isBehindGlobe");
                    }
                  ),
                  destructableLayers: Object.values(a).filter(function (e) {
                    return e.hasOwnProperty("_destructor");
                  }),
                  pausableLayers: Object.values(a).filter(function (e) {
                    return e.hasOwnProperty("pauseAnimation");
                  }),
                }
              );
            },
            init: function (e, t, a) {
                ...
                if (n) {
                  t.scene.scale.set(1e-6, 1e-6, 1e-6),
                    t.tweenGroup.add(
                      new r.K({ k: 1e-6 })
                        .to({ k: 1 }, 600)
                        .easing(r.GS.Quadratic.Out)
                        .onUpdate(function (e) {
                          var a = e.k;
                          return t.scene.scale.set(a, a, a);
                        })
                        .start()
                    );
                  var e = new ts.Vector3(0, 1, 0);
                  t.tweenGroup.add(
                    new r.K({ rot: 2 * Math.PI })
                      .to({ rot: 0 }, 1200)
                      .easing(r.GS.Quintic.Out)
                      .onUpdate(function (a) {
                        var l = a.rot;
                        return t.scene.setRotationFromAxisAngle(e, l);
                      })
                      .start()
                  );
                }
              ...
              void 0 === o || o ? t.globeLayer.onReady(i) : i(),
                this._animationCycle();
            },
            update: function (e) {},
          }),
          (window.THREE ? window.THREE : { Group: l.Group }).Group,
          !0
        );
    },
  },
]);
//# sourceMappingURL=5e094596.ecf328b47987d18a.js.map
